  ...
  return (
    <main className="mx-auto max-w-3xl bg-ik-paper px-6 py-10 font-ik-sans text-ik-ink">
      <header className="mb-8 flex items-start justify-between">
        <div>
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-[15px] font-medium">Green Park Eco Hotel</div>
      ...
      <footer className="mt-10 border-t border-ik-rule pt-4 text-[11px] text-ik-ink-3">
        Green Park Eco Hotel · This invoice was generated by Green Park Eco Hotel catering operations software. Visit
