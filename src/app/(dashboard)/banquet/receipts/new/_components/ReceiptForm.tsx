    ...
    <div className="grid max-w-4xl gap-4">
      <section className="grid gap-3 rounded-2xl border border-ik-rule bg-ik-card shadow-ik-card p-4">
        <div className="grid gap-3 sm:grid-cols-3">
          ...
          <div className="grid gap-1.5">
            <Label htmlFor="sourceContact">From (vendor / person)</Label>
            <Input id="sourceContact" placeholder="e.g. Royal Packaging — Mr Patel" value={sourceContact} onChange={(e) => setSourceContact(e.target.value)} />
          </div>
          <div className="grid gap-1.5">
